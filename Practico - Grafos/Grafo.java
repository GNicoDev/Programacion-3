...
/*
* Operación  			Método en Java	     		Complejidad promedio	     Complejidad peor caso
-----------------------------------------------------------------------------------------------------------------
* Insertar un par
* clave-valor			put(K key, V value)			O(1)	         				O(n) (por colisiones extremas)

* Obtener valor de
* una clave	            get(K key)					O(1)	              			O(n)

* Verificar si
* contiene una clave	containsKey(K key)			O(1)	      					O(n)

* Eliminar una clave	remove(K key)				O(1)							O(n)

* Obtener todas
* las claves			keySet()					O(n)

* Obtener todos los
* valores				values()					O(n)

* Obtener todos los
* pares clave-valor		entrySet()					O(n)
*
*  En la práctica, gracias al buen diseño del hashCode() y el equals(), el rendimiento suele mantenerse
* cercano a O(1).
* */
